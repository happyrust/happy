...
export const en = {
    ...
    settingsAutoMode: {
        title: 'Auto Mode',
        autoModeGroup: 'Auto Mode',
        autoModeFooter: 'When enabled, automatically sends the selected template message when AI finishes responding.',
        enableAutoMode: 'Enable Auto Mode',
        autoModeIsEnabled: 'Auto mode is enabled',
        autoModeIsDisabled: 'Auto mode is disabled',
        
        cycleSettings: 'Cycle Settings',
        cycleSettingsFooterUnlimited: 'Unlimited cycles - will continue automatically until manually disabled',
        cycleSettingsFooterLimited: ({ count }: { count: number }) => 
            `Maximum ${count} cycle${count === 1 ? '' : 's'}. After reaching the limit, auto mode will stop for this session.`,
        maximumCycles: 'Maximum Cycles (0 = unlimited)',
        enterNumber: 'Enter number (0 for unlimited)',
        unlimitedCycles: 'Unlimited cycles',
        maximumCyclesCount: ({ count }: { count: number }) => 
            `Maximum ${count} cycle${count === 1 ? '' : 's'}`,
        currentCycleCounts: 'Current Cycle Counts',
        sessionLabel: ({ id }: { id: string }) => `Session: ${id.substring(0, 8)}...`,
        cycleProgress: ({ current, max }: { current: number; max: string }) => `${current} / ${max}`,
        resetCycleCount: 'Reset Cycle Count',
        resetCycleCountMessage: 'Reset cycle count for this session?',
        resetAllCycleCounts: 'Reset All Cycle Counts',
        resetAllCycleCountsMessage: 'Reset cycle counts for all sessions?',
        resetAll: 'Reset All',
        
        selectedTemplate: 'Selected Template',
        selectedTemplateFooter: ({ name }: { name: string }) => `Current template: "${name}"`,
        noTemplateSelected: 'No template selected. Add a template below to get started.',
        noTemplateTitle: 'No template selected',
        selectTemplateSubtitle: 'Select a template from the list below',
        
        templates: 'Templates',
        templatesFooter: 'Templates are automatically sent when AI finishes responding (if auto mode is enabled).',
        noTemplates: 'No templates',
        addFirstTemplate: 'Add your first template below',
        
        addEditTemplate: ({ isEditing }: { isEditing: boolean }): string => isEditing ? 'Edit Template' : 'Add Template',
        templateName: 'Template Name',
        enterTemplateName: 'Enter template name',
        templateContent: 'Template Content',
        enterTemplateContent: 'Enter template content (this will be sent automatically)',
        templateNameRequired: 'Template name and content are required',
    ...
    sessionInfo: {
        ...
        autoModeDescriptionDefault: ({ globalState }: { globalState: string }) => `Auto mode is disabled by default for this session. Global setting: ${globalState}. Enable manually to override.`,
        autoModeDisabledDefault: 'Auto mode is disabled (default, can be enabled manually)',
        ...
        autoModeTemplateLabel: 'Auto Mode Template',
        autoModeTemplateEmpty: 'No templates available. Add templates in Settings > Auto Mode.',
        autoModeTemplatePickerTitle: 'Choose Auto Mode Template',
        autoModeTemplatePickerSubtitle: 'Select the template that will be sent automatically when auto mode runs.',
        autoModeSessionMaxLabel: 'Session Cycle Limit',
        autoModeSessionMaxSet: ({ count }: { count: number }) => `Limited to ${count} ${count === 1 ? 'cycle' : 'cycles'} for this session`,
        autoModeSessionMaxUnlimited: 'Unlimited cycles for this session',
        autoModeSessionMaxGlobal: ({ count }: { count: number }) => `Using global limit of ${count} ${count === 1 ? 'cycle' : 'cycles'}`,
        autoModeSessionMaxGlobalUnlimited: 'Using global unlimited cycle setting',
        autoModeSessionMaxPromptTitle: 'Set session cycle limit',
        autoModeSessionMaxPromptMessage: 'Enter the maximum auto mode cycles for this session (0 for unlimited). Leave empty to use the global setting.',
        autoModeSessionMaxPromptPlaceholder: 'e.g. 5',
        autoModeSessionMaxInvalid: 'Please enter a non-negative whole number.',
        customAutoModeMessage: 'Custom Auto-Send Message',
        customAutoModeMessageEmpty: 'No custom message. Tap to set a custom message for auto-send.',
        customAutoModeMessageTitle: 'Custom Auto-Send Message',
        customAutoModeMessagePrompt: 'Enter a custom message to be sent automatically when AI finishes responding. Leave empty to use templates instead.',
        customAutoModeMessagePlaceholder: 'e.g., Continue with the next task',
        clearCustomMessage: 'Clear Custom Message',
    ...
    agentInput: {
        templatePicker: 'Auto-reply Templates',
        selectTemplate: 'Select a template',
        noTemplatesAvailable: 'No templates available',
        currentMessage: 'Current Message',
        setAsAutoSend: 'Set as Auto-Send Message',
