...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Reinicia remotamente esta sesión en tu máquina',
        restartSessionSuccess: 'La sesión se está reiniciando...',
        restartSessionFailed: 'Error al reiniciar la sesión',
        restartSessionMachineOffline: 'La máquina está desconectada. Por favor, inicia el daemon en tu computadora primero.',
        restartingSession: 'Reiniciando sesión...',
