...
export const es: TranslationStructure = {
    ...
    connect: {
        ...
        authUrlHelpTitle: '¿No puedes escanear el código QR?',
        authUrlHelpDescription: 'Copia o comparte este enlace de autenticación y ábrelo en un dispositivo ya vinculado.',
        authUrlLabel: 'Enlace de autenticación',
        copyAuthUrl: 'Copiar enlace',
        shareAuthUrl: 'Compartir enlace',
        authUrlCopied: 'Enlace de autenticación copiado al portapapeles',
        authUrlCopyFailed: 'No se pudo copiar el enlace de autenticación',
        shareAuthUrlFailed: 'No se pudo compartir el enlace de autenticación',
    },
    ...
    settingsAutoMode: {
        ...
        autoModeFooter: 'Cuando está habilitado, envía automáticamente el mensaje de plantilla seleccionado cuando la IA termina de responder.',
        enableAutoMode: 'Habilitar Modo Automático',
        autoModeIsEnabled: 'El modo automático está habilitado',
        autoModeIsDisabled: 'El modo automático está deshabilitado',
        
        cycleSettings: 'Configuración de Ciclos',
        cycleSettingsFooterUnlimited: 'Ciclos ilimitados - continuará automáticamente hasta que se deshabilite manualmente',
        cycleSettingsFooterLimited: ({ count }: { count: number }) => 
            `Máximo ${count} ciclo${count === 1 ? '' : 's'}. Después de alcanzar el límite, el modo automático se detendrá para esta sesión.`,
        maximumCycles: 'Ciclos Máximos (0 = ilimitados)',
        enterNumber: 'Ingrese un número (0 para ilimitados)',
        unlimitedCycles: 'Ciclos ilimitados',
        maximumCyclesCount: ({ count }: { count: number }) => 
            `Máximo ${count} ciclo${count === 1 ? '' : 's'}`,
        currentCycleCounts: 'Contadores de Ciclos Actuales',
        sessionLabel: ({ id }: { id: string }) => `Sesión: ${id.substring(0, 8)}...`,
        cycleProgress: ({ current, max }: { current: number; max: string }) => `${current} / ${max}`,
        resetCycleCount: 'Restablecer Contador de Ciclos',
        resetCycleCountMessage: '¿Restablecer el contador de ciclos para esta sesión?',
        resetAllCycleCounts: 'Restablecer Todos los Contadores de Ciclos',
        resetAllCycleCountsMessage: '¿Restablecer los contadores de ciclos para todas las sesiones?',
        resetAll: 'Restablecer Todo',
        
        selectedTemplate: 'Plantilla Seleccionada',
        selectedTemplateFooter: ({ name }: { name: string }) => `Plantilla actual: "${name}"`,
        noTemplateSelected: 'No hay plantilla seleccionada. Agregue una plantilla a continuación para comenzar.',
        noTemplateTitle: 'No hay plantilla seleccionada',
        selectTemplateSubtitle: 'Seleccione una plantilla de la lista a continuación',
        
        templates: 'Plantillas',
        templatesFooter: 'Las plantillas se envían automáticamente cuando la IA termina de responder (si el modo automático está habilitado).',
        noTemplates: 'Sin plantillas',
        addFirstTemplate: 'Agregue su primera plantilla a continuación',
        
        addEditTemplate: ({ isEditing }: { isEditing: boolean }): string => isEditing ? 'Editar Plantilla' : 'Agregar Plantilla',
        templateName: 'Nombre de la Plantilla',
        enterTemplateName: 'Ingrese el nombre de la plantilla',
        templateContent: 'Contenido de la Plantilla',
        enterTemplateContent: 'Ingrese el contenido de la plantilla (se enviará automáticamente)',
        templateNameRequired: 'El nombre y el contenido de la plantilla son obligatorios',
        
        deleteTemplate: 'Eliminar Plantilla',
        deleteTemplateMessage: '¿Está seguro de que desea eliminar esta plantilla?',
        delete: 'Eliminar',
        cancel: 'Cancelar',
        save: 'Guardar',
    ...
    sessionInfo: {
        ...
        autoModeDescriptionDefault: ({ globalState }: { globalState: string }) => `El modo automático está deshabilitado por defecto para esta sesión. Configuración global: ${globalState}. Habilítalo manualmente para sobrescribir.`,
        autoModeDisabledDefault: 'El modo automático está deshabilitado (por defecto, se puede habilitar manualmente)',
        ...
        autoModeTemplateLabel: 'Plantilla del modo automático',
        autoModeTemplateEmpty: 'No hay plantillas disponibles. Añade plantillas en Ajustes > Modo automático.',
        autoModeTemplatePickerTitle: 'Elegir plantilla del modo automático',
        autoModeTemplatePickerSubtitle: 'Selecciona la plantilla que se enviará automáticamente cuando se ejecute el modo automático.',
        autoModeSessionMaxLabel: 'Límite de ciclos de la sesión',
        autoModeSessionMaxSet: ({ count }: { count: number }) => `Límite de ${count} ${count === 1 ? 'ciclo' : 'ciclos'} para esta sesión`,
        autoModeSessionMaxUnlimited: 'Esta sesión no tiene límite de ciclos',
        autoModeSessionMaxGlobal: ({ count }: { count: number }) => `Usando el límite global de ${count} ${count === 1 ? 'ciclo' : 'ciclos'}`,
        autoModeSessionMaxGlobalUnlimited: 'Usando la configuración global sin límite',
        autoModeSessionMaxPromptTitle: 'Definir límite de ciclos de la sesión',
        autoModeSessionMaxPromptMessage: 'Introduce el máximo de ciclos del modo automático para esta sesión (0 para ilimitado). Déjalo vacío para usar la configuración global.',
        autoModeSessionMaxPromptPlaceholder: 'p. ej. 5',
        autoModeSessionMaxInvalid: 'Introduce un número entero no negativo.',
        customAutoModeMessage: 'Mensaje personalizado de envío automático',
        customAutoModeMessageEmpty: 'Sin mensaje personalizado. Toque para establecer un mensaje personalizado.',
        customAutoModeMessageTitle: 'Mensaje personalizado de envío automático',
        customAutoModeMessagePrompt: 'Ingrese un mensaje personalizado para enviarse automáticamente cuando la IA termine de responder. Déjelo vacío para usar plantillas.',
        customAutoModeMessagePlaceholder: 'ej., Continuar con la siguiente tarea',
    ...
    agentInput: {
        templatePicker: 'Plantillas de respuesta automática',
        selectTemplate: 'Seleccionar una plantilla',
        noTemplatesAvailable: 'No hay plantillas disponibles',
        currentMessage: 'Mensaje actual',
        setAsAutoSend: 'Establecer como mensaje de envío automático',
        saveAsTemplate: 'Guardar como plantilla',
        enterTemplateName: 'Ingrese el nombre de la plantilla',
        templateNamePlaceholder: 'ej., Continuar trabajando',
        templates: 'Plantillas',
        repeatSend: 'Envío repetido',
        repeatSendOnce: 'Enviar 1 vez',
        repeatSendTimes: ({ times }: { times: number }) => `Enviar ${times} ${times === 1 ? 'vez' : 'veces'}`,
        repeatSendMenuTitle: 'Seleccionar repeticiones',
        customRepeatOption: 'Personalizado...',
        customRepeatTitle: 'Repeticiones personalizadas',
        customRepeatMessage: 'Ingrese el número de veces para enviar este mensaje',
        customRepeatPlaceholder: 'ej., 20',
        customRepeatInvalid: 'Ingrese un número entero positivo',
        permissionMode: {
