...
export const pt: TranslationStructure = {
    ...
    connect: {
        ...
        authUrlHelpTitle: 'Não consegue escanear o QR code?',
        authUrlHelpDescription: 'Copie ou compartilhe este link de autenticação e abra-o em um dispositivo já vinculado.',
        authUrlLabel: 'Link de autenticação',
        copyAuthUrl: 'Copiar link',
        shareAuthUrl: 'Compartilhar link',
        authUrlCopied: 'Link de autenticação copiado para a área de transferência',
        authUrlCopyFailed: 'Falha ao copiar o link de autenticação',
        shareAuthUrlFailed: 'Não foi possível compartilhar o link de autenticação',
    },
    ...
    settingsAutoMode: {
        ...
        autoModeGroup: 'Modo Automático',
        autoModeFooter: 'Quando habilitado, envia automaticamente a mensagem de modelo selecionada quando a IA termina de responder.',
        enableAutoMode: 'Habilitar Modo Automático',
        autoModeIsEnabled: 'O modo automático está habilitado',
        autoModeIsDisabled: 'O modo automático está desabilitado',
        
        cycleSettings: 'Configurações de Ciclos',
        cycleSettingsFooterUnlimited: 'Ciclos ilimitados - continuará automaticamente até ser desabilitado manualmente',
        cycleSettingsFooterLimited: ({ count }: { count: number }) => 
            `Máximo ${count} ciclo${count === 1 ? '' : 's'}. Após atingir o limite, o modo automático será interrompido para esta sessão.`,
        maximumCycles: 'Ciclos Máximos (0 = ilimitado)',
        enterNumber: 'Digite um número (0 para ilimitado)',
        unlimitedCycles: 'Ciclos ilimitados',
        maximumCyclesCount: ({ count }: { count: number }) => 
            `Máximo ${count} ciclo${count === 1 ? '' : 's'}`,
        currentCycleCounts: 'Contadores de Ciclos Atuais',
        sessionLabel: ({ id }: { id: string }) => `Sessão: ${id.substring(0, 8)}...`,
        cycleProgress: ({ current, max }: { current: number; max: string }) => `${current} / ${max}`,
        resetCycleCount: 'Redefinir Contador de Ciclos',
        resetCycleCountMessage: 'Redefinir contador de ciclos para esta sessão?',
        resetAllCycleCounts: 'Redefinir Todos os Contadores de Ciclos',
        resetAllCycleCountsMessage: 'Redefinir os contadores de ciclos para todas as sessões?',
        resetAll: 'Redefinir Tudo',
        
        selectedTemplate: 'Modelo Selecionado',
        selectedTemplateFooter: ({ name }: { name: string }) => `Modelo atual: "${name}"`,
        noTemplateSelected: 'Nenhum modelo selecionado. Adicione um modelo abaixo para começar.',
        noTemplateTitle: 'Nenhum modelo selecionado',
        selectTemplateSubtitle: 'Selecione um modelo da lista abaixo',
        
        templates: 'Modelos',
        templatesFooter: 'Os modelos são enviados automaticamente quando a IA termina de responder (se o modo automático estiver habilitado).',
        noTemplates: 'Sem modelos',
        addFirstTemplate: 'Adicione seu primeiro modelo abaixo',
        
        addEditTemplate: ({ isEditing }: { isEditing: boolean }): string => isEditing ? 'Editar Modelo' : 'Adicionar Modelo',
        templateName: 'Nome do Modelo',
        enterTemplateName: 'Digite o nome do modelo',
        templateContent: 'Conteúdo do Modelo',
        enterTemplateContent: 'Digite o conteúdo do modelo (será enviado automaticamente)',
        templateNameRequired: 'O nome e o conteúdo do modelo são obrigatórios',
        
        deleteTemplate: 'Excluir Modelo',
        deleteTemplateMessage: 'Tem certeza de que deseja excluir este modelo?',
        delete: 'Excluir',
        cancel: 'Cancelar',
        save: 'Salvar',
    ...
    sessionInfo: {
        ...
        autoModeDescriptionDefault: ({ globalState }: { globalState: string }) => `O modo automático está desabilitado por padrão para esta sessão. Configuração global: ${globalState}. Habilite manualmente para sobrescrever.`,
        autoModeDisabledDefault: 'O modo automático está desabilitado (padrão, pode ser habilitado manualmente)',
        autoModeEnabledOverride: 'O modo automático está habilitado (sobrescrita de sessão)',
        autoModeDisabledOverride: 'O modo automático está desabilitado (sobrescrita de sessão)',
        autoModeOverrideDescription: ({ globalState }: { globalState: string }) => `Esta sessão tem uma configuração personalizada do modo automático. Configuração global: ${globalState}`,
        useGlobalAutoMode: 'Usar configuração global',
        useGlobalAutoModeDescription: 'Reverter para a configuração global do modo automático',
        clearAutoModeOverride: 'Limpar sobrescrita de sessão',
        clearAutoModeOverrideMessage: 'Isso removerá a configuração do modo automático específica desta sessão e usará a configuração global.',
        autoModeSessionMaxLabel: 'Limite de ciclos da sessão',
        autoModeSessionMaxSet: ({ count }: { count: number }) => `Limite de ${count} ${count === 1 ? 'ciclo' : 'ciclos'} para esta sessão`,
        autoModeSessionMaxUnlimited: 'Esta sessão não possui limite de ciclos',
        autoModeSessionMaxGlobal: ({ count }: { count: number }) => `Usando o limite global de ${count} ${count === 1 ? 'ciclo' : 'ciclos'}`,
        autoModeSessionMaxGlobalUnlimited: 'Usando a configuração global sem limite',
        autoModeSessionMaxPromptTitle: 'Definir limite de ciclos da sessão',
        autoModeSessionMaxPromptMessage: 'Informe o número máximo de ciclos do modo automático para esta sessão (0 para ilimitado). Deixe em branco para usar a configuração global.',
        autoModeSessionMaxPromptPlaceholder: 'ex.: 5',
        autoModeSessionMaxInvalid: 'Informe um número inteiro não negativo.',
        customAutoModeMessage: 'Mensagem personalizada de envio automático',
        customAutoModeMessageEmpty: 'Sem mensagem personalizada. Toque para definir uma mensagem personalizada.',
        customAutoModeMessageTitle: 'Mensagem personalizada de envio automático',
        customAutoModeMessagePrompt: 'Digite uma mensagem personalizada para envio automático quando a IA terminar de responder. Deixe vazio para usar modelos.',
        customAutoModeMessagePlaceholder: 'ex., Continuar com a próxima tarefa',
        clearCustomMessage: 'Limpar mensagem personalizada',
        clearCustomMessageConfirm: 'Isso removerá a mensagem personalizada e usará o modelo selecionado.',
        clearCustomMessageSubtitle: 'Usar modelo em vez disso',
        autoModeTemplateLabel: 'Modelo do modo automático',
    ...
    agentInput: {
        templatePicker: 'Modelos de resposta automática',
        selectTemplate: 'Selecionar um modelo',
        noTemplatesAvailable: 'Nenhum modelo disponível',
        currentMessage: 'Mensagem atual',
        setAsAutoSend: 'Definir como mensagem de envio automático',
        saveAsTemplate: 'Salvar como modelo',
        enterTemplateName: 'Digite o nome do modelo',
        templateNamePlaceholder: 'ex., Continuar trabalhando',
        templates: 'Modelos',
        repeatSend: 'Envio repetido',
        repeatSendOnce: 'Enviar 1 vez',
        repeatSendTimes: ({ times }: { times: number }) => `Enviar ${times} ${times === 1 ? 'vez' : 'vezes'}`,
        repeatSendMenuTitle: 'Selecionar repetições',
        customRepeatOption: 'Personalizado...',
        customRepeatTitle: 'Repetições personalizadas',
        customRepeatMessage: 'Digite o número de vezes para enviar esta mensagem',
        customRepeatPlaceholder: 'ex., 20',
        customRepeatInvalid: 'Digite um número inteiro positivo',
        permissionMode: {
