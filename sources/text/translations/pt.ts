...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Reinicia remotamente esta sessão na sua máquina',
        restartSessionSuccess: 'A sessão está sendo reiniciada...',
        restartSessionFailed: 'Falha ao reiniciar a sessão',
        restartSessionMachineOffline: 'A máquina está offline. Por favor, inicie o daemon no seu computador primeiro.',
        restartingSession: 'Reiniciando sessão...',
