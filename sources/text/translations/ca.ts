...
export const ca: TranslationStructure = {
    ...
    connect: {
        ...
        authUrlHelpTitle: 'No pots escanejar el codi QR?',
        authUrlHelpDescription: 'Copia o comparteix aquest enllaç d\'autenticació i obre\'l en un dispositiu ja enllaçat.',
        authUrlLabel: 'Enllaç d\'autenticació',
        copyAuthUrl: 'Copia l\'enllaç',
        shareAuthUrl: 'Comparteix l\'enllaç',
        authUrlCopied: 'Enllaç d\'autenticació copiat al porta-retalls',
        authUrlCopyFailed: 'No s\'ha pogut copiar l\'enllaç d\'autenticació',
        shareAuthUrlFailed: 'No s\'ha pogut compartir l\'enllaç d\'autenticació',
    },
    ...
    settingsAutoMode: {
        title: 'Mode Automàtic',
        autoModeGroup: 'Mode Automàtic',
        autoModeFooter: 'Quan està habilitat, envia automàticament el missatge de plantilla seleccionat quan la IA acaba de respondre.',
        enableAutoMode: 'Habilitar Mode Automàtic',
        autoModeIsEnabled: 'El mode automàtic està habilitat',
        autoModeIsDisabled: 'El mode automàtic està deshabilitat',
        
        cycleSettings: 'Configuració de Cicles',
        cycleSettingsFooterUnlimited: 'Cicles il·limitats - continuarà automàticament fins que es desactivi manualment',
        cycleSettingsFooterLimited: ({ count }: { count: number }) => 
            `Màxim ${count} cicle${count === 1 ? '' : 's'}. Després d'arribar al límit, el mode automàtic s'aturarà per a aquesta sessió.`,
        maximumCycles: 'Cicles Màxims (0 = il·limitats)',
        enterNumber: 'Introduïu un número (0 per il·limitats)',
        unlimitedCycles: 'Cicles il·limitats',
        maximumCyclesCount: ({ count }: { count: number }) => 
            `Màxim ${count} cicle${count === 1 ? '' : 's'}`,
        currentCycleCounts: 'Comptadors de Cicles Actuals',
        sessionLabel: ({ id }: { id: string }) => `Sessió: ${id.substring(0, 8)}...`,
        cycleProgress: ({ current, max }: { current: number; max: string }) => `${current} / ${max}`,
        resetCycleCount: 'Restablir Comptador de Cicles',
        resetCycleCountMessage: 'Restablir el comptador de cicles per a aquesta sessió?',
        resetAllCycleCounts: 'Restablir Tots els Comptadors de Cicles',
        resetAllCycleCountsMessage: 'Restablir els comptadors de cicles per a totes les sessions?',
        resetAll: 'Restablir Tot',
        
        selectedTemplate: 'Plantilla Seleccionada',
        selectedTemplateFooter: ({ name }: { name: string }) => `Plantilla actual: "${name}"`,
        noTemplateSelected: 'No hi ha plantilla seleccionada. Afegeix una plantilla a continuació per començar.',
        noTemplateTitle: 'No hi ha plantilla seleccionada',
        selectTemplateSubtitle: 'Selecciona una plantilla de la llista a continuació',
        
        templates: 'Plantilles',
        templatesFooter: 'Les plantilles s\'envien automàticament quan la IA acaba de respondre (si el mode automàtic està habilitat).',
        noTemplates: 'Sense plantilles',
        addFirstTemplate: 'Afegeix la teva primera plantilla a continuació',
        
        addEditTemplate: ({ isEditing }: { isEditing: boolean }): string => isEditing ? 'Editar Plantilla' : 'Afegir Plantilla',
        templateName: 'Nom de la Plantilla',
        enterTemplateName: 'Introdueix el nom de la plantilla',
        templateContent: 'Contingut de la Plantilla',
        enterTemplateContent: 'Introdueix el contingut de la plantilla (s\'enviarà automàticament)',
        templateNameRequired: 'El nom i el contingut de la plantilla són obligatoris',
        
        deleteTemplate: 'Eliminar Plantilla',
        deleteTemplateMessage: 'Estàs segur que vols eliminar aquesta plantilla?',
        delete: 'Eliminar',
        cancel: 'Cancel·lar',
        save: 'Guardar',
        addTemplate: 'Afegir Plantilla',
    },
    ...
    sessionInfo: {
        ...
        autoModeDescriptionDefault: ({ globalState }: { globalState: string }) => `El mode automàtic està deshabilitat per defecte per a aquesta sessió. Configuració global: ${globalState}. Habilita'l manualment per sobrescriure.`,
        autoModeDisabledDefault: 'El mode automàtic està deshabilitat (per defecte, es pot habilitar manualment)',
        ...
        autoModeTemplateLabel: 'Plantilla del mode automàtic',
        autoModeTemplateEmpty: 'No hi ha plantilles disponibles. Afegeix-ne a Configuració > Mode automàtic.',
        autoModeTemplatePickerTitle: 'Escull la plantilla del mode automàtic',
        autoModeTemplatePickerSubtitle: 'Selecciona la plantilla que s\'enviarà automàticament quan s\'executi el mode automàtic.',
        autoModeSessionMaxLabel: 'Límit de cicles de la sessió',
        autoModeSessionMaxSet: ({ count }: { count: number }) => `Límit de ${count} ${count === 1 ? 'cicle' : 'cicles'} per a aquesta sessió`,
        autoModeSessionMaxUnlimited: 'Aquesta sessió té cicles il·limitats',
        autoModeSessionMaxGlobal: ({ count }: { count: number }) => `S\'utilitza el límit global de ${count} ${count === 1 ? 'cicle' : 'cicles'}`,
        autoModeSessionMaxGlobalUnlimited: 'S\'utilitza la configuració global sense límit',
        autoModeSessionMaxPromptTitle: 'Defineix el límit de cicles de la sessió',
        autoModeSessionMaxPromptMessage: 'Introdueix el nombre màxim de cicles del mode automàtic per a aquesta sessió (0 per il·limitat). Deixa-ho buit per utilitzar la configuració global.',
        autoModeSessionMaxPromptPlaceholder: 'p. ex. 5',
        autoModeSessionMaxInvalid: 'Introdueix un enter no negatiu.',
        customAutoModeMessage: 'Missatge personalitzat d\'enviament automàtic',
        customAutoModeMessageEmpty: 'Sense missatge personalitzat. Toqueu per establir un missatge personalitzat.',
        customAutoModeMessageTitle: 'Missatge personalitzat d\'enviament automàtic',
        customAutoModeMessagePrompt: 'Introduïu un missatge personalitzat per enviar automàticament quan la IA acabi de respondre. Deixeu-lo buit per utilitzar plantilles.',
        customAutoModeMessagePlaceholder: 'p. ex., Continuar amb la següent tasca',
        clearCustomMessage: 'Esborrar missatge personalitzat',
        clearCustomMessageConfirm: 'Això eliminarà el missatge personalitzat i utilitzarà la plantilla seleccionada.',
        clearCustomMessageSubtitle: 'Utilitzar plantilla en el seu lloc',
    ...
    agentInput: {
        templatePicker: 'Plantilles de resposta automàtica',
        selectTemplate: 'Selecciona una plantilla',
        noTemplatesAvailable: 'No hi ha plantilles disponibles',
        currentMessage: 'Missatge actual',
        setAsAutoSend: 'Establir com a missatge d\'enviament automàtic',
        saveAsTemplate: 'Desar com a plantilla',
        enterTemplateName: 'Introduïu el nom de la plantilla',
        templateNamePlaceholder: 'p. ex., Continuar treballant',
        templates: 'Plantilles',
        repeatSend: 'Enviament repetit',
        repeatSendOnce: 'Enviar 1 cop',
        repeatSendTimes: ({ times }: { times: number }) => `Enviar ${times} ${times === 1 ? 'cop' : 'cops'}`,
        repeatSendMenuTitle: 'Selecciona repeticions',
        customRepeatOption: 'Personalitzat...',
        customRepeatTitle: 'Repeticions personalitzades',
        customRepeatMessage: 'Introduïu el nombre de vegades per enviar aquest missatge',
        customRepeatPlaceholder: 'p. ex., 20',
        customRepeatInvalid: 'Introduïu un nombre enter positiu',
        permissionMode: {
